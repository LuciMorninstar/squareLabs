...
const Partners = () => {
  ...
  <div key={`${partner.name}-${index}`} className="w-max h-20 lg:w-max lg:h-24 xl:h-28">
    <img src={assetSrc(partner.logo)} className="grayscale-100 hover:grayscale-0 opacity-50 hover:opacity-100 w-full h-full transition-all duration-200 ease-in-out" alt={partner.name}/>
  </div>
))}
  </div>
